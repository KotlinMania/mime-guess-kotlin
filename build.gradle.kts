...
kotlin {
    ...
    val xcf = XCFramework("MimeGuess")

    macosArm64 {
        binaries.framework { baseName = "MimeGuess"; xcf.add(this) }
    }
    iosArm64 {
        binaries.framework { baseName = "MimeGuess"; xcf.add(this) }
    }
    ...
    swiftExport {
        moduleName = "MimeGuess"
        flattenPackage = "io.github.kotlinmania.mimeguess"
    }

    android {
        namespace = "io.github.kotlinmania.mimeguess"
        compileSdk = 34
        minSdk = 24
...
mavenPublishing {
    ...
    coordinates(group.toString(), "mime-guess-kotlin", version.toString())

    pom {
        name.set("mime-guess-kotlin")
        description.set("Kotlin Multiplatform port of abonander/mime_guess - A simple crate for detection of a file's MIME type by its extension")
        inceptionYear.set("2026")
        url.set("https://github.com/KotlinMania/mime-guess-kotlin")
        ...
        scm {
            url.set("https://github.com/KotlinMania/mime-guess-kotlin")
            connection.set("scm:git:git://github.com/KotlinMania/mime-guess-kotlin.git")
            developerConnection.set("scm:git:ssh://github.com/KotlinMania/mime-guess-kotlin.git")
        }
    }
}
...
val fullTargetBuildTasks = listOf(
    ...
    "assembleMimeGuessXCFramework",
    "assembleMimeGuessDebugXCFramework",
    "assembleMimeGuessReleaseXCFramework",
    "assembleDebugIosFatFrameworkForMimeGuessXCFramework",
    "assembleReleaseIosFatFrameworkForMimeGuessXCFramework",
    "assembleDebugIosSimulatorFatFrameworkForMimeGuessXCFramework",
    "assembleReleaseIosSimulatorFatFrameworkForMimeGuessXCFramework",
    "assembleDebugMacosFatFrameworkForMimeGuessXCFramework",
    "assembleReleaseMacosFatFrameworkForMimeGuessXCFramework",
    "assembleDebugTvosFatFrameworkForMimeGuessXCFramework",
    "assembleReleaseTvosFatFrameworkForMimeGuessXCFramework",
    "assembleDebugTvosSimulatorFatFrameworkForMimeGuessXCFramework",
    "assembleReleaseTvosSimulatorFatFrameworkForMimeGuessXCFramework",
    "assembleDebugWatchosFatFrameworkForMimeGuessXCFramework",
    "assembleReleaseWatchosFatFrameworkForMimeGuessXCFramework",
    "assembleDebugWatchosSimulatorFatFrameworkForMimeGuessXCFramework",
    "assembleReleaseWatchosSimulatorFatFrameworkForMimeGuessXCFramework",
