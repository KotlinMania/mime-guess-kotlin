...
This file is the quick-reference operating contract for mime-guess-kotlin. The longer
...
mime-guess-kotlin is a Kotlin Multiplatform port of the upstream Rust crate or module
[`mime_guess`](https://crates.io/crates/mime_guess). Upstream Rust is the behavioral oracle while the
